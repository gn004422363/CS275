...
app.get("/search_render", function (req,res){
	...
	//Filling the string with html content that contains the display selections
	str += "<center>Select a student:</center><br><center><select id=\"search_select\"><option value=\"ml3546\">ml3546</option><option value=\"abc123\">abc123</option><option value=\"xyz890\">xyz890</option></select></center><br><center><button onClick=\"search_select()\">Select Student</button></center>";
...
//GET call to /dispaly_term_ml3546
app.get('/display_term_ml3546', function (req,res){
	
	html = ""
	
	//Output to console that a connection was made
	console.log("Connection made to /display_term_ml3546");
	
	//Outputting to the console that the computeFactorial function of Calculator was called
	console.log("Display Term ml3546");
	...
	con.query("SELECT termYear from GRADES WHERE studentID = 'ml3546'", function(err,rows,fields) {
		...
		if (err)
			...
			html += "</select></center><br><center><button onClick=\"display_table_ml3546()\">Select Term</button></center>";
...
//GET call to /dispaly_term_ml3546
app.get('/display_table_ml3546', function (req,res){
	...
	//Output to console that a connection was made
	console.log("Connection made to /display_table_ml3546");
	
	//Outputting to the console that the computeFactorial function of Calculator was called
	console.log("Display Table ml3546");
	...
	query_string = "SELECT GRADES.studentID, STUDENT.firstName, STUDENT.lastName, GRADES.termYear, COURSE.courseID, COURSE.courseDesc, GRADES.grade FROM STUDENT, COURSE, GRADES WHERE (GRADES.studentID = 'ml3546') AND (GRADES.termYear = \'" + term + "\') AND (STUDENT.studentID = GRADES.studentID) AND (COURSE.courseID = GRADES.courseID)"
